      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
          ...
          <motion.div
            role="dialog"
            aria-modal="true"
            className="relative z-10 flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:rounded-2xl"
...
export function Progress({
  ...
  pct: number;
  tone?: "brand" | "green" | "amber" | "red" | "violet" | "blue";
}) {
