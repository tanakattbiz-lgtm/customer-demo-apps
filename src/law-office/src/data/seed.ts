...
export function buildSeed(): AppData {
  ...
  const notifications: Notification[] = [
    { id: "n1", channel: "メール", event: "請求書送付", to: "watanabe@technova.example.io", subject: "【○○法律事務所】請求書(INV-2026-0124)送付のお知らせ", at: subHours(now, 2).toISOString(), status: "開封" },
    ...
    { id: "n8", channel: "メール", event: "請求書送付", to: "hayase@urban-estate.example.co.jp", subject: "【○○法律事務所】請求書送付のお知らせ", at: subHours(now, 72).toISOString(), status: "送信済" },
  ];
