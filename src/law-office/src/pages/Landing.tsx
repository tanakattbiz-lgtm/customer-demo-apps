...
export default function Landing() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    pushNotification({
      ...
      event: "面談予約確定",
      to: form.email.trim(),
      subject: "【○○法律事務所】無料相談のお申し込みを受け付けました",
      status: "送信済",
    });
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5 sm:px-6">
          <button onClick={() => scrollTo("top")} className="flex items-center gap-2.5">
            ...
            <div className="text-left leading-tight">
              <div className="font-serif text-[15px] font-semibold text-ink-900">○○法律事務所</div>
              <div className="text-[10px] tracking-wide text-ink-400">LAW OFFICE</div>
            </div>
          </button>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-ink-800">東京都港区海岸2-4-8 ○○ビル9F</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col justify-between gap-8 sm:flex-row">
            <div className="max-w-sm">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="font-serif font-semibold">○○法律事務所</div>
                  <div className="text-[10px] tracking-wide text-brand-300">LAW OFFICE</div>
                </div>
              </div>
              <p className="mt-4 text-sm leading-relaxed text-brand-200">
                東京都港区海岸2-4-8 ○○ビル9F<br />
