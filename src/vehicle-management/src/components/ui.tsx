      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
          ...
          <motion.div
            role="dialog"
            aria-modal="true"
            className="thin-scroll relative z-10 max-h-[92vh] w-full overflow-y-auto rounded-t-3xl bg-white shadow-2xl sm:rounded-2xl"
  ...
  return (
    <Card className="p-4 sm:p-5">
      <div className="flex items-start justify-between gap-2">
        ...
        {icon && (
          <div className={"grid h-8 w-8 place-items-center rounded-lg " + ring[tone]}>
            {icon}
          </div>
        )}
      </div>
