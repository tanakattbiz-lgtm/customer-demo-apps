...
<svg xmlns="http://www.w3.org/2000/svg" width="640" height="400" viewBox="0 0 640 400">
  ...
  <text x="320" y="362" font-family="Consolas, monospace" font-size="26" fill="#e7ebf3" text-anchor="middle" letter-spacing="4">ODO ${String(Math.round(e)).padStart(6,`0`)}</text>
  <text x="320" y="46" font-family="Arial" font-size="18" fill="#7a8296" text-anchor="middle">サンプル: 車両メーター写真</text>
</svg>`)}function i(){return n(`
<svg xmlns="http://www.w3.org/2000/svg" width="640" height="400" viewBox="0 0 640 400">
...
</svg>`)}export{t as i,r as n,a as r,i as t};